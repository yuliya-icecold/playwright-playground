...
test("Google.com - Hover over speaker icon", async ({page}) => {
    ...
    // await expect(page.locator("*", {hasText: "Search by voice"})).toBeVisible()
    await expect(page.getByText("Search by voice")).toBeVisible()
    // await expect(page.getByRole("generic", {name: "Search by voice"})).not.toBeVisible()
    // await expect(page.getByRole("generic", {name: "Search by voice"})).toBeVisible()
})
test("Google search results - Hover over search button", async ({page}) => {
    ...
    // await expect(page.getByRole("generic", {name: "Search", exact: true})).not.toBeVisible()
